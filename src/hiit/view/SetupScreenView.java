...
public class SetupScreenView{
	...
	public SetupScreenView(Stage primaryStage, Model model, SetupScreenController controller) {
		...
		// Use the following line of code for quicker testing
		// this.model.addEntry("Test Exercise", "12", "12");
		...
		// Handle Start and Workout Button
		...
		// Created with the help of lecture slides
		// 3 BooleanBindings to handle wrong input for the textfields
		...
		// only allowing numbers in the sets and reps textfields via valideInputOnChange
		...
		// Disable the workout button when there is no exercise 
